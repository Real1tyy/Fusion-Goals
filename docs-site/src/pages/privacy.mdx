...
Because we do not store personal data, we cannot identify individual visitors or associate analytics data with specific users. If you have questions about data processing, please open an issue on [GitHub](https://github.com/Real1tyy/Fusion-Goals/issues).
